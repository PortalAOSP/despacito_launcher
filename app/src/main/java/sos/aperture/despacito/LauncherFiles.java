...
public class LauncherFiles {
    ...
    public static final String OLD_SHARED_PREFERENCES_KEY = "sos.aperture.despacito.prefs";
    public static final String MANAGED_USER_PREFERENCES_KEY = "sos.aperture.despacito.managedusers.prefs";
