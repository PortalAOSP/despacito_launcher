...
import sos.aperture.despacito.AutoInstallsLayout.LayoutParserCallback;
import sos.aperture.despacito.LauncherSettings.Favorites;
import sos.aperture.despacito.LauncherSettings.WorkspaceScreens;
import sos.aperture.despacito.compat.UserManagerCompat;
import sos.aperture.despacito.graphics.IconShapeOverride;
import sos.aperture.despacito.preferences.IPreferenceProvider;
import sos.aperture.despacito.provider.RestoreDbTask;
import sos.aperture.despacito.util.ManagedProfileHeuristic;
import sos.aperture.despacito.util.NoLocaleSqliteContext;
