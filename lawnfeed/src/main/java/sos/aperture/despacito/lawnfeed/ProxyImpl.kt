package sos.aperture.despacito.lawnfeed
...
import sos.aperture.despacito.launcherclient.ILauncherClientProxy
import sos.aperture.despacito.launcherclient.ILauncherClientProxyCallback
import sos.aperture.despacito.launcherclient.LauncherClientProxyConnection
import sos.aperture.despacito.launcherclient.WindowLayoutParams
import sos.aperture.despacito.lawnfeed.updater.Updater
...
class ProxyImpl(val context: Context) : ILauncherClientProxy.Stub() {
    ...
    override fun init(callback: ILauncherClientProxyCallback): Int {
        allowed = "sos.aperture.despacito.plah" == callingPackage || "sos.aperture.despacito" == callingPackage
        enforcePermission()
